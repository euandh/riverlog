  ...
  return (
    <main className="p-8 font-sans max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[50vh] text-center">
      ...
      <p className="text-lg text-gray-600 mb-8">
        Either the section or river you're looking for doesn't exist, or I don't have any notes from it! If there has been an error, please let me know at euan@riverlog.uk
      </p>
      <Link href="/">
